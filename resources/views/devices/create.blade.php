...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('device.store') }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('post')
                        ...
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('Agregar dispositivo') }}</h4>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('serial') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('serial') ? ' is-invalid' : '' }}"
                                                name="serial" id="input-serial" type="text"
                                                placeholder="{{ __('Serial') }}" value="{{ old('serial') }}"
