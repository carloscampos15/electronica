...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('dump.update', $dump) }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('put')
                        ...
                        <div class="card ">
                            <div class="card-header card-header-primary custom-card-header">
                                <h4 class="card-title">{{ __('Editar basurero') }}</h4>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}"
                                                ...
                                                placeholder="{{ __('Dirección') }}" value="{{ old('address', $dump->address) }}"
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('weight') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('weight') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('weight', $dump->weight) }}" required="true" aria-required="true" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('level') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('level') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('level', $dump->level) }}" required="true" aria-required="true" />
                                            @if ($errors->has('level'))
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('device_id') ? ' has-danger' : '' }}">
                                            <select class="form-control{{ $errors->has('device_id') ? ' is-invalid' : '' }}"
                                                name="device_id" id="input-device_id" type="text" value="{{ old('device_id', $dump->device->id) }}"
                                                required="true" aria-required="true">
